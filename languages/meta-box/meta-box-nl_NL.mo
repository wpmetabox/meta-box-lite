...
<script type="text/javascript" src="https://translate.wordpress.org/wp-includes/js/admin-bar.min.js?ver=6.8-alpha-59602" id="admin-bar-js"></script>
	...
	<body class="admin-bar no-customize-support is-classic-theme wporg-make make-polyglots no-js">
		...
		<div id="wpadminbar" class="nojq nojs">
				...
				<ul role='menu' id='wp-admin-bar-top-secondary' class="ab-top-secondary ab-top-menu"><li role='group' id='wp-admin-bar-log-in'><a class='ab-item' role="menuitem" href='https://login.wordpress.org/?redirect_to=https%3A%2F%2Ftranslate.wordpress.org%2Fprojects%2Fwp-plugins%2Fmeta-box%2Fdev%2Fnl_NL%2Fdefault%2Fexport-translations%2F%3Fformat%3Dmo&#038;locale=en_US'>Log In</a></li><li role='group' id='wp-admin-bar-register'><a class='ab-item' role="menuitem" href='https://login.wordpress.org/register?locale=en_US'>Register</a></li></ul>			</div>
		</div>
...
<script type="text/javascript">
		jQuery('.glossary-links').prepend('<a href="/projects/wp-plugins/meta-box/dev/nl_NL/default/export-translations/playground/" style="font-weight: 600;">Translate Live</a> <strong class="separator">•</strong> ');
	</script>	<script>
		( function( $ ) {
			$( function() {
